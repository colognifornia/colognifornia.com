...
return [
    ...
    'description' => "Here's what we do to ensure your personal data is processed securely as well as in compliance with German and European data protection regulations.",

    'intro' => [
        'We take your privacy and the protection of your data very seriously.',
        'contact' => 'In case of any questions or issues you might encounter regarding your data,
        feel free to reach out to us at %email%.',
    ],

    'overview' => [
        'heading' => '1. An overview of data protection',
    ],
    ...
    'data-recording-how' => [
        'heading' => 'How do we record your data?',
        'text' => [
            'We collect your data as a result of your sharing of your data with us. This may, for instance be information
            you include in an email you send us.',
    ...
    'purpose' => [
        'heading' => 'What are the purposes we use your data for?',
        'text' => [
    ...
    'rights' => [
        'heading' => 'What rights do you have as far as your information is concerned?',
        'text' => [
            ...
            disclosed in section "%link%" on this website if you have questions about this or any
    ...
    'providers' => [
        'heading' => '2. Hosting and processing by external service providers',
    ],
    ...
    'hosting' => [
        ...
        'model-contract' => [
            ...
            'text' => [
                'We have concluded so-called EU Model Contract Clauses with our host
        ...
        'transparency' => [
            ...
            'text' => [
                ...
                about our host and the concluded order processing contract as well as the EU Model Contract Clauses:',
    ...
    'communication' => [
        'heading' => 'External communication via e-mail',
        'text' => [
            'Requests by e-mail as also described under section "Request by e-mail or telephone" of this Data Protection Declaration
            are handled by an external service provider. Any personal data included in these requests, especially your e-mail address,
            are processed and stored on the servers of the external service provider.',
        ...
        'model-contract' => [
            ...
            'text' => [
                ...
                in order to adduce adequate safeguards with respect to the protection of privacy and
                fundamental rights and freedoms of individuals, as stated in the contract,
                when processing data according to this Data Protection Declaration.',
                'These are Standard Contractual Clauses (processors)
                for the purposes of Article 26(2) of Directive 95/46/EC for the transfer of personal data
                to processors established in third countries which do not ensure an adequate level of data protection.',
            ],
        ],
        'transparency' => [
            ...
            'text' => [
                ...
                'Colognifornia employs products and services from G Suite
                (cloud-based communication and office enterprise software) for handling external communication via e-mail.',
                'The order processor as stated in the concluded order processing contract is:',
                'Google LLC, Google Ireland Limited, Google Asia Pacific Pte. Ltd.,
                or any other entity that directly or indirectly controls,
                is controlled by, or is under common control with Google LLC (as applicable, "Google")',
                'The concluded order processing contract can be found at:',
                'The party which has agreed on the EU Model Contract Clauses with us is, as stated in the contract:',
                'Google LLC (formerly known as Google Inc.),
                1600 Amphitheatre Parkway, Mountain View, California 94043 USA.',
    ...
    'external-customer-data-processing' => [
        ...
        'text' => [
            ...
            of this Data Protection Declaration are processed and stored by an external service provider.
            For example, your contact details such as name, address, e-mail address, telephone number, etc.
            are stored and processed on the servers of the external service provider.
            The same applies to contract and invoice data or data on payment behaviour.',
            'The processing of these data is based on Art. 6 para. 1 lit. b GDPR,
            since the processing is necessary for the execution of a contract or to carry out pre-contractual measures.
            At the same time, the processing serves to fulfil legal obligations of the controller in relation to
        ...
        'transparency' => [
            ...
            'text' => [
                'For the purpose of transparency, we provide you with the following information
                about our service provider and the concluded order processing contract:',
    ...
    'consent-revocation' => [
        ...
        'text' => [
            ...
            revoke at any time any consent you have already given us. To do so, all you are required to do is to send us an
    ...
    'right-object-special' => [
        'heading' => 'Right to object to the collection of data in special cases; right to object to direct advertising (Art. 21 GDPR)',
        'text' => [
    ...
    'right-complaint' => [
        'heading' => 'Right to log a complaint with the competent supervisory agency',
        'text' => [
    ...
    'data-information' => [
        'heading' => 'Information about, rectification and eradication of data',
        'text' => [
            ...
            contact us at any time at the address provided in section "%link%".',
        ],
    ],

    'processing-restrictions' => [
        'heading' => 'Right to demand processing restrictions',
        'text' => [
            'You have the right to demand the imposition of restrictions as far as the processing of your personal data is
            concerned. To do so, you may contact us at any time at the address provided in section "%link%".
    ...
    'spam-mails' => [
        'heading' => 'Rejection of unsolicited e-mails',
        'text' => [
            'We herewith object to the use of contact information published in conjunction with the mandatory
            information to be provided in section "%link%" to send us promotional and information
    ...
    'request' => [
        ...
        'text' => [
            'If you contact us by e-mail or telephone, your request, including all resulting personal data (name,
    ...
    'contract-data' => [
        'heading' => 'Data transfer upon closing of contracts for services and digital content',
        'text' => [
