...
return [
    'title' => 'Impressum',
    'description' => 'Hier finden Sie rechtliche Informationen sowie Kontaktangaben, zu deren Angabe wir gesetzlich verpflichtet sind.',

    'information' => [
        'heading' => 'Angaben gemäß § 5 TMG',
        'address' => [
            'Jasper Raddatz',
            'Colognifornia (Einzelunternehmen)',
            'Salzburger Weg 47',
            '50858 Köln',
            'Deutschland',
        ],
    ...
    'contact' => [
        ...
        'footnote' => '* Bitte nur nach vorheriger Anfrage und Absprache per E-Mail verwenden.',
    ],
    ...
    'dispute' => [
        ...
        'text' => [
            ...
            'Eine Liste mit den Kontaktdaten anderer anerkannter Streitbeilegungsstellen finden Sie unter',
        ],
        'address' => [
        ...
        'phone' => 'Telefon: +49 (0)221 28 56 020',
