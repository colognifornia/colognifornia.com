...
return [
    'title' => 'Legal Notice',
    'description' => 'Here you can find legal as well as contact information required by law.',

    'information' => [
        'heading' => 'Information pursuant to § 5 TMG',
        'address' => [
            'Jasper Raddatz',
            'Colognifornia (individual company)',
            'Salzburger Weg 47',
            'Cologne, 50858',
            'Germany',
        ],
    ...
    'contact' => [
        ...
        'footnote' => '* Please use only after prior request and arrangement via email.',
    ],

    'tax' => [
        'heading' => 'VAT ID',
        'text' => 'Sales tax identification number according to § 27 a of the Sales Tax Law:',
        'vat-id' => 'DE325678142',
    ],
    ...
    'dispute' => [
        ...
        'text' => [
            ...
            'A list with the contact details of other recognized dispute resolution bodies can be found at',
        ],
        'address' => [
            "Anwaltliche Verbraucherschlichtungsstelle NRW e. V. (Lawyers' Consumer Conciliation Board NRW)",
            'Reichenspergerplatz 1',
            'Cologne, 50670',
            'Germany',
        ],
        'phone' => 'Phone: +49 (0)221 28 56 020',
        'fax' => 'Fax: +49 (0)221 44 14 57',
        'email' => 'Email: %email%',
        'web' => 'Website: %web%',
    ],
    ...
    'contents' => [
        ...
        'text' => [
            ...
            German Telemedia Act (TMG). However, according to Paragraphs 8 to 10 German Telemedia Act (TMG),
            ...
            case, liability is only possible at the time of knowledge about a specific violation of law. Illegal contents will
